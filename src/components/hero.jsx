...
export default function Hero() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#1A1C2B] px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
        ...
        <div className="text-white space-y-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="#"
              className="px-6 py-3 rounded-full bg-[#24263A] hover:bg-[#2F3147] transition flex items-center gap-2"
            >
